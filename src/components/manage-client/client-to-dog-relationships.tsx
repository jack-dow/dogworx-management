...
import { FormControl, FormField, FormGroup, FormItem, FormMessage, FormSection, FormSheetGroup } from "../ui/form";
...
function ClientToDogRelationships({
	...
	const { getValues, setValue } = useFormContext<ManageClientFormSchema>();
	...
	const groupTitle = "Dogs";
	const groupDescription = "Manage the relationships between this client and their dogs.";
	...
	return (
		<>
			...
			<SectionWrapper
				title={type === "sheet" ? groupTitle : "Manage Relationships"}
				description={
					type === "sheet"
						? groupDescription
			...
			>
				<FieldsWrapper
					title={type === "form" ? groupTitle : undefined}
					description={type === "form" ? groupDescription : undefined}
				>
