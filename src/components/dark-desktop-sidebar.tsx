						...
						<li className="-mx-2 mt-auto">
							{user ? (
								...
								<div className="flex h-auto w-full items-center justify-start gap-x-4 px-2 py-3">
									<Skeleton className="h-10 w-10 rounded-md bg-slate-50/20" />
									<div className="flex flex-col items-center justify-start">
										<Skeleton className="h-4 w-[70px] bg-slate-50/20" />
										<Skeleton className="mr-auto mt-0.5 h-5 w-[60px] bg-slate-50/20" />
									</div>
								</div>
							)}
						</li>
