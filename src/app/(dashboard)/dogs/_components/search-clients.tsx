...
const SearchClients = React.forwardRef<HTMLButtonElement, SearchClientsProps>(
	({ selectedClients, onClientSelect }, ref) => {
		...
		const [results, setResults] =
			React.useState<Array<ManageDogFormSchema["clientRelationships"][number]["client"]>>(selectedClients);
