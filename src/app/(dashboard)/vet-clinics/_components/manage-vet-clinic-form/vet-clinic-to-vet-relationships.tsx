...
import { actions, type VetClinicById, type VetsSearch } from "~/actions";
...
type Vet = ManageVetClinicFormSchema["vetToVetClinicRelationships"][number]["vet"];
...
function VetClinicToVetRelationships({
	...
	const { setValue, getValues } = useFormContext<ManageVetClinicFormSchema>();
	...
	return (
		<>
			...
			<ConfirmFormNavigationDialog
				...
				onConfirm={() => {
					void router.push(`/vet-clinics/${isConfirmingNavigationToDog}`);
				}}
			/>
