	...
	return (
		<div className="grid grid-cols-1 gap-4 sm:grid-cols-6">
			<div className="col-span-full">
				<h3 className="text-base font-semibold leading-7 text-gray-900">Vets</h3>
					...
					<li className="flex items-center justify-between gap-x-6 py-4">
						<div className="flex items-center gap-x-4">
							...
							<div className="min-w-0 flex-auto">
								<p className="text-sm font-semibold leading-6 text-gray-900">Alice Doe</p>
								<p className="truncate text-xs leading-5 text-gray-500">alicedoe@vets.com</p>
							</div>
						</div>
						<Select>
